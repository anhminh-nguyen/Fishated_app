export const COMICS = [
  {
    ...
    secondDesc:`Ở trường, Shijima được Majime Yamashita, một cô bé có quả trứng ốp la ở trên đầu. Majime nói rằng từ khi sinh ra mình đã có quả trứng rán đó. Hai người dần trở nên gắn bó với nhau, và cùng lúc đó, nhiều hiện tượng kỳ ​​lạ khác xảy ra trong thị trấn của họ.`,
