...
export default function Intro() {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-white text-neutral-800 shadow-xl border border-neutral-200 transition-colors duration-500">
      ...
      <div className="absolute inset-0 z-0 h-[300px] md:h-full">
        <Image
      ...
      <div className="relative z-10 px-6 py-12 md:px-16 md:py-24 flex flex-col items-center text-center">
        {/* Animated Icon */}
        <div className="mb-10 animate-bounce hidden md:block">
          <Image
            ...
            height={60}
            unoptimized
            className="rotate-180 drop-shadow-[0_0_15px_rgba(0,0,0,0.1)] opacity-80 invert"
          />
        </div>

        {/* Titles */}
        <div className="space-y-6 mb-12">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter text-neutral-800 drop-shadow-sm">
            少女終末旅行
          </h1>
        ...
        {/* Description Card */}
        <div className="max-w-4xl bg-neutral-50/50 backdrop-blur-md p-6 md:p-10 rounded-2xl border border-neutral-200 shadow-inner">
          <div className="space-y-6 text-base md:text-xl leading-relaxed text-neutral-600 font-medium text-left md:text-center">
        ...
        <div className="mt-12 pt-8 border-t border-neutral-100 w-full max-w-3xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-xs md:text-sm text-neutral-400 text-center md:text-left font-medium">
              Bản dịch tiếng Việt bởi <span className="text-orange-500 font-bold">Fishated</span><br />
              © Tsukumizu / Shinchosha
            </p>
            
            <div className="flex justify-center gap-8 text-neutral-500 font-bold text-sm">
              <a 
